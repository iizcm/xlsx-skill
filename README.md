...
cp -r productivity/xlsx ~/.hermes/skills/productivity/xlsx/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/xlsx-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/xlsx-skill.git ~/.hermes/skills/productivity/xlsx/
```
...
```text
skill_view(name="productivity/xlsx")
```
...
```text
Use the xlsx skill to <describe your specific task here>
```
...
```text
Gunakan skill xlsx untuk <deskripsikan tugas spesifik Anda di sini>
```
